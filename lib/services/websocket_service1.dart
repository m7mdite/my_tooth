...
class WebSocketService1 extends GetxService {
  static WebSocketService1 get to => Get.find();
  ...
  Future<void> _handleVerifyAccepted(dynamic data) async {
    ...
    try {
      ...
      if (!isControllerReady) {
        debugPrint('❌ NotificationController not available, saving notification locally');
