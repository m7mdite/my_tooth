...
//   @override
//   void onInit() async {
//     profileModel?.firstName = authService.getFullName();
//     profileModel!.email = authService.getEmail()!;
//     profileModel?.phoneNumber = authService.getPhoneNumber()!;
//     profileModel?.gender = authService.getGender()!;
//     // profileModel?.age = authService.getAge()!;
//      await fetchingData();
//     super.onInit();
//     // await fetchingData();

//     // // name = TextEditingController(text: "${data['first_name']}  ${data['last_name']}");
//     name = TextEditingController(text: authService.getFullName());
//     // age = TextEditingController(text: "${data['age']}");
//     // gender = TextEditingController(text: authService.getGender());
//     // email = TextEditingController(text: authService.getEmail());
//     // phoneNumber = TextEditingController(text: data['phone_number']);

//     profilePicture = data['profile_photo']['url'] == null
//         ? ""
...
//   refreshData() async {
//     await fetchingData();
//     name.text = authService.getFullName();
//     age.text = "${data['age']}";
//     gender.text = authService.getGender()!;
//     email.text = authService.getEmail()!;
...
//       data = response['data'];
//       print(  " بيانت $data");
//       authService.saveAllFromJson(data);
//       print("$data");
//     }
//   }
