...
import '../../../controllers/patient_controller/patient_profile_controller.dart';
import '../../widgets/default_container_profile.dart';

class PatientProfileScreen extends StatelessWidget {
  final PatientProfileControllerImp controller =
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<PatientProfileControllerImp>(builder: (_) {
        return ListView(
          children: [
            Center(
              child: InkWell(
