    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: requestModel.gender == 'male'
                  ? Colors.blue
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                Text(
                  toothLocation?[requestModel.toothLocation] ?? "غير محدد",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 12,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          width: 10,
                          decoration: BoxDecoration(
                              color: requestModel.painSeverity >= 1
                                  ? Colors.redAccent
                                  : Colors.white,
                        ...
                        Container(
                          ...
                          width: 10,
                          decoration: BoxDecoration(
                              color: requestModel.painSeverity >= 2
                                  ? Colors.red
                                  : Colors.white,
                              border: Border.all(color: Colors.blue),
                              borderRadius: BorderRadius.circular(30)),
                        ...
                        Container(
                          ...
                          width: 10,
                          decoration: BoxDecoration(
                              color: requestModel.painSeverity >= 3
                                  ? Colors.redAccent
                                  : Colors.white,
                              border: Border.all(color: Colors.blue),
                              borderRadius: BorderRadius.circular(30)),
                        ...
                        Container(
                          ...
                          width: 10,
                          decoration: BoxDecoration(
                              color: requestModel.painSeverity >= 4
                                  ? Colors.red
                                  : Colors.white,
                              border: Border.all(color: Colors.blue),
                              borderRadius: BorderRadius.circular(30)),
                        ...
                        Container(
                          ...
                          width: 10,
                          decoration: BoxDecoration(
                            color: requestModel.painSeverity>=5?Colors.red:Colors.white,
                            border: Border.all(color: Colors.blue)
                            ,
                            borderRadius: BorderRadius.circular(30)
                          ),
