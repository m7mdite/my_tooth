...
class ThemeSwitcherWidget extends StatelessWidget {
    ...
    return GetBuilder<ThemeController>(
      builder: (controller) {
        return Row(
          ...
          children: [
            _colorCircle(controller, AppThemeType.blue, Colors.blue),
            _colorCircle(controller, AppThemeType.dark, const Color(0xFF121212)),
            _colorCircle(controller, AppThemeType.pink, Colors.pink),
          ],
        );
      },
    );
  ...
  Widget _colorCircle(ThemeController controller, AppThemeType type, Color color) {
