...
import 'widgets/profile_screen_public.dart'; // تأكد من المسار الصحيح
...
class ChatScreenn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(
        ChatController(conversationId: conversationId, otherUserId: otherUserId));
    ...
    return AppBar(
      ...
      title: InkWell(
        onTap: () {
          ...
          Get.to(() => PublicProfileScreen(userId: otherUserId));
        },
        ...
        child: Row(
          ...
          children: [
            CircleAvatar(
              radius: 18,
              backgroundImage: (otherProfilePhotoUrl != null && otherProfilePhotoUrl!.isNotEmpty)
                  ? NetworkImage("http://127.0.0.1:5000/${otherProfilePhotoUrl!}")
...
//   Widget build(BuildContext context) {
//     final controller = Get.put(
//         ChatController(conversationId: conversationId, otherUserId: userId));
...
//         actions: [
//           CircleAvatar(child: Icon(Icons.join_full),)
//         ],
//       ),
//       body: Container(
//         decoration: BoxDecoration(
//           image: DecorationImage(image: AssetImage(AppConstants.defaultBackgroundImage),fit: BoxFit.cover,colorFilter: ColorFilter.linearToSrgbGamma())
//         ),
//         child: Column(
//           children: [
//             Expanded(
...
//           child: Container(
//              padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
//             margin: EdgeInsets.only(bottom: 12.5,top: 12.5 ,right: isMe?50:10,left: isMe?10:50),
//             decoration: BoxDecoration(
//               color: isMe && message.messageType=='text'
//                   ? const Color.fromARGB(217, 68, 137, 255)
//                   : const Color.fromARGB(149, 255, 255, 255),
...
//               ],
//             ),
//             child:message.messageType=="text"? Column(
//               mainAxisSize: MainAxisSize.min,
//               crossAxisAlignment: CrossAxisAlignment.start,
//               children: [
//                 SelectableText(
...
//               width: 250,
//               decoration: BoxDecoration(
//                 image: DecorationImage(image: NetworkImage("http://localhost:5000/${message.content}"),fit: BoxFit.cover)
//               ),
//             ),
//           ),
//         ),
