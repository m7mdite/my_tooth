...
class _UnifiedEditProfileScreenState extends State<UnifiedEditProfileScreen> {
  ...
  void initState() {
    super.initState();
    firstNameController = TextEditingController(text: authService.getFirstName() ?? '');
    fatherNameController = TextEditingController(text: authService.getFatherName() ?? '');
    lastNameController = TextEditingController(text: authService.getLastName() ?? '');
